...
*/
	...
	var setSize = function(options) {
		...
		containerSize.width		= containerSize.width -	containerSize.margin.left - containerSize.margin.right;
		containerSize.height	= options.height?options.height:500;
		containerSize.height	= containerSize.height -	containerSize.margin.top - containerSize.margin.bottom;	
	}
	...
	this.createGraphic = function(inputData, options){
		...
		x = d3.time.scale().range([0, containerSize.width]);
		y = d3.scale.linear().range([containerSize.height, 0]);
...
//			});
		...
		svg = d3.select(options.container)
			.append('svg')
			.attr('width', containerSize.width + containerSize.margin.left + containerSize.margin.right)
			.attr('height', containerSize.height + containerSize.margin.top + containerSize.margin.bottom)
			.attr('class', 'trend')
			.append('g')
...
//		var data = _data;
		...
		svg.append('g')
			...
			.call(xAxis.tickSize(-containerSize.height, 0, 0))
			;
