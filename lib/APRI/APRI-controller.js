...
//                , {'id':'ApriD3Logo'}
  ...
  //              , {'id':'three'}
              ...
              //  , {'id':'TrackballControls'}
				...
				, {'id':'apri-leafletctrl-timeline'}
				, {'id':'apri-leafletctrl-timeline.css'}
...
//											, 'src': '/client/apri-client-sys/ext/leaflet-1.0.0-rc1/leaflet.js' } 
        ...
        , 'apri-leafletctrl-timeline':      { 'require' : ['d3']
                                            , 'waitFor' : ['d3']
                                            , 'src': '/client/apri-client-sys/lib/APRI/APRI-leafletctrl-timeline.js' }
        , 'apri-leafletctrl-timeline.css':      { 'require' : []
 			               ,'type': 'css'
                                            , 'waitFor' : []
                                            , 'href': '/client/apri-client-sys/lib/APRI/APRI-leafletctrl-timeline.css' }
