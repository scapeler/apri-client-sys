...
//			}
        ...
        , 'handlebars':                	{ 'require' : []
											, 'depend' : []
											, 'src': '/js/handlebars-v3.0.3.js' }
									//		, 'src': '/js/handlebars-v2.0.0.js' }
        , 'handlebars-runtime':                	{ 'require' : []
											, 'depend' : []
//											, 'src': '/js/handlebars.runtime-v2.0.0.js' }
											, 'src': '/js/handlebars.runtime-v3.0.3.js' }
//        , 'CookieWarning':                	{ 'require' : []
//											, 'depend' : []
//											, 'src': '/js/CookieWarning-master/js/cookiewarning3.js' } 
        , 'Leaflet':                	{ 'require' : []
											, 'depend' : ['L']
											, 'src': '/js/leaflet-0.7.3/leaflet.js' } 
        , 'proj4-compressed':           { 'require' : ['Leaflet']
											, 'depend' : ['proj4']
											, 'src': '/js/Proj4Leaflet-master/lib/proj4-compressed.js' }
        , 'proj4leaflet':               { 'require' : ['proj4-compressed']
										 , 'waitFor' : ['Leaflet','proj4-compressed']
										 , 'depend' : []
										 , 'src': '/js/Proj4Leaflet-master/src/proj4leaflet.js' }
        , 'leaflet-sidebar-v2':               { 'require' : []
										 , 'waitFor' : ['Leaflet']
										 , 'depend' : []
										 , 'src': '/js/sidebar-v2-gh-pages/js/leaflet-sidebar.min.js' }
        ...
        , 'L.Control.Sidebar':          { 'require' : []
                                            , 'waitFor' : ['Leaflet']
                                            , 'src': '/js/leaflet-sidebar-master/src/L.Control.Sidebar.js' }
        ...
        , 'L.Control.Layers.Minimap':   { 'require' : []
                                            , 'waitFor' : ['Leaflet']
											, 'src': '/js/Leaflet.layerscontrol-minimap-gh-pages/L.Control.Layers.Minimap.js'
										}
        , 'L.Map.Sync':            		{ 'require' : []
                                            , 'waitFor' : ['Leaflet']
											, 'src': '/js/Leaflet.layerscontrol-minimap-gh-pages/lib/L.Map.Sync.js'
										}
        , 'Control.MiniMap':            { 'require' : []
                                            , 'waitFor' : ['Leaflet']
											, 'depend' : ['L.Control.MiniMap']
											, 'src': '/js/Leaflet-MiniMap-master/src/Control.MiniMap.js'
										}
        , 'L.Control.Locate':           { 'require' : []
                                            , 'waitFor' : ['Leaflet']
                                            , 'src': '/js/leaflet-locatecontrol-gh-pages/src/L.Control.Locate.js' }
        , 'Control.Loading':            { 'require' : []
                                            , 'waitFor' : ['Leaflet']
                                            , 'src': '/js/Leaflet.loading-master/src/Control.Loading.js' }
        , 'Control.FullScreen':         { 'require' : []
                                            , 'waitFor' : ['Leaflet']
                                            , 'src': '/js/brunob-leaflet.fullscreen-342abea/Control.FullScreen.js' }
        , 'leaflet.draw':               { 'require' : []
                                            , 'waitFor' : ['Leaflet']
                                            , 'src': '/js/Leaflet.draw-master/dist/leaflet.draw-src.js' }
//        , 'leaflet.draw.Edit.Rectangle': { 'require' : []
//                                            , 'waitFor' : ['Leaflet']
//                                            , 'src': '/js/Leaflet.draw-master/src/edit/handler/Edit.Rectangle.js' }
        , 'leaflet.measurecontrol':     { 'require' : []
                                            , 'waitFor' : ['Leaflet','leaflet.draw']
											, 'depend' : []
											, 'src': '/js/Leaflet.MeasureControl-gh-pages/leaflet.measurecontrol.js'
										}
        ...
        , 'leaflet.ajax':               { 'require' : []
                                            , 'waitFor' : ['Leaflet']
                                            , 'src': '/js/leaflet-ajax-master/dist/leaflet.ajax.min.js' }
        , 'leaflet.contextmenu':      	{ 'require' : []
                                            , 'waitFor' : ['Leaflet']
                                            , 'src': '/js/Leaflet.contextmenu-master/dist/leaflet.contextmenu.js' }
        , 'leaflet.markercluster':      { 'require' : []
                                            , 'waitFor' : ['Leaflet']
                                            , 'src': '/js/Leaflet.markercluster-master/dist/leaflet.markercluster.js' }
        , 'leaflet-oms':      			{ 'require' : []
                                            , 'waitFor' : ['Leaflet']
                                            , 'src': '/js/Leaflet-overlappingmarkerspiderfier/oms.min.js' }
        , 'leaflet.plotter':      		{ 'require' : []
                                            , 'waitFor' : ['Leaflet']
                                            , 'src': '/js/leaflet-plotter-master/dist/leaflet.plotter.min.js' }
        , 'moment':                     { 'require' : [], 'src': '/js/moment.min.js' }
        , 'video-js':                     { 'require' : [], 'src': '/js/video-js/video.js' }
   //     , 'timeline':                   { 'require' : [], 'src': '/apri-client-sys/lib/TimelineJS-master/build/js/timeline-min.js' } //automaticly loaded by storyjs-embed
        ...
        , 'gallery-formmgr': {
                'type': 'js'
				, 'waitFor' : ['YUI']
              , 'src': '/js/yui3/yui-gallery/gallery-formmgr/gallery-formmgr-min.js'
           }
        , 'gallery-popup-calendar': {
                'type': 'js'
				, 'waitFor' : ['YUI']
				, 'require' : [{'id': 'gallery-popup-calendar.css'}]
              , 'src': '/js/gallery-popup-calendar/gallery-popup-calendar.js'
           }
        , 'gallery-accordion': {
                'type': 'js'
				, 'waitFor' : ['YUI']
				, 'require' : [{'id': 'gallery-accordion.css'}]
              , 'src': '/js/gallery-accordion/gallery-accordion.js'
           }
...
//                'type': 'css'
//              , 'href': '/js/malihu-custom-scrollbar-plugin-master/jquery.mCustomScrollbar.css'
//           }

        , 'gallery-popup-calendar.css': {
                'type': 'css'
              , 'href': '/js/gallery-popup-calendar/assets/skins/sam/gallery-popup-calendar-skin.css'
           }
        , 'gallery-accordion.css': {
                'type': 'css'
              , 'href': '/js/gallery-accordion/assets/skins/sam/gallery-accordion.css'
           }
        ...
        , 'cssgrids-min.css': {
                'type': 'css'
              , 'href': '/js/yui3/yui/build/cssgrids/cssgrids-min.css'
           }
        , 'cssbase-min.css': {
                'type': 'css'
              , 'href': '/js/yui3/yui/build/cssbase/cssbase-min.css'
           }
...
//<link ref="stylesheet" type="text/css" href="/js/yui3/yui/build/cssbase/cssbase-min.css"/>
        ...
        , 'leaflet.css': {
                'type': 'css'
              , 'href': '/js/leaflet-0.7.2/leaflet.css'
           }
        , 'leaflet-sidebar-v2.css': {
                'type': 'css'
              , 'href': '/js/sidebar-v2-gh-pages/css/leaflet-sidebar.css'

           }
        , 'leaflet-sidebar-v2.scss': {
                'type': 'css'
              , 'href': '/js/sidebar-v2-gh-pages/scss/leaflet-sidebar.scss'
           }
        , 'leaflet-sidebar-v2-base.scss': {
                'type': 'css'
              , 'href': '/js/sidebar-v2-gh-pages/scss/_base.scss'
           }
		, 'apri-accordion.css': {
                'type': 'css'
...
//<link rel="stylesheet" href="/js/leaflet-0.7.2/leaflet.css" />
        ...
        , 'leaflet.contextmenu.css': {
                  'type': 'css'
				, 'href': '/js/Leaflet.contextmenu-master/dist/leaflet.contextmenu.css' 
			}
        , 'MarkerCluster.Default.css': {
                'type': 'css'
              , 'href': '/js/Leaflet.markercluster-master/dist/MarkerCluster.Default.css'
           }
        , 'MarkerCluster.css': {
                'type': 'css'
              , 'href': '/js/Leaflet.markercluster-master/dist/MarkerCluster.css'
           }
        , 'leaflet.draw.css': {
                'type': 'css'
              , 'href': '/js/Leaflet.draw-master/dist/leaflet.draw.css'
           }
        , 'Control.MiniMap.css': {
                'type': 'css'
              , 'href': '/js/Leaflet-MiniMap-master/src/Control.MiniMap.css'
           }
        , 'L.Control.Locate.css': {
                'type': 'css'
              , 'href': '/js/leaflet-locatecontrol-gh-pages/src/L.Control.Locate.css'
           }
        , 'Control.FullScreen.css': {
                'type': 'css'
              , 'href': '/js/brunob-leaflet.fullscreen-342abea/Control.FullScreen.css'
           }
        , 'Control.Loading.css': {
                'type': 'css'
              , 'href': '/js/Leaflet.loading-master/src/Control.Loading.css'
           }
        , 'leaflet.measurecontrol.css': {
                'type': 'css'
              , 'href': '/js/Leaflet.MeasureControl-gh-pages/leaflet.measurecontrol.css'
           }
        , 'control.layers.minimap.css': {
                'type': 'css'
              , 'href': '/js/Leaflet.layerscontrol-minimap-gh-pages/control.layers.minimap.css'
           }
        , 'L.Control.Sidebar.css': {
                'type': 'css'
              , 'href': '/js/leaflet-sidebar-master/src/L.Control.Sidebar.css'
           }
        , 'leaflet.fusesearch.css': {
                'type': 'css'
              , 'href': '/js/leaflet-fusesearch-master/src/leaflet.fusesearch.css'
           }
        , 'font-awesome-4.2.0.css': {
                'type': 'css'
              //, 'href': '/js/font-awesome-4.2.0/css/font-awesome.css'
			  , 'href': 'https://maxcdn.bootstrapcdn.com/font-awesome/4.2.0/css/font-awesome.min.css'
           }
        , 'leaflet.awesome-markers.css': {
                'type': 'css'
              //, 'href': '/js/font-awesome-4.2.0/css/font-awesome.css'
			  , 'href': '/js/Leaflet.awesome-markers-2.0-develop/dist/leaflet.awesome-markers.css'
           }
        , 'leaflet.awesome-markers': {
                'require' : []
              , 'waitFor' : ['Leaflet']
			  , 'src': '/js/Leaflet.awesome-markers-2.0-develop/dist/leaflet.awesome-markers.min.js'
           }
//        , 'fontawesome-webfont.woff': {
//                'type': 'css'
//              , 'href': '/js/font-awesome-4.2.0/fonts/fontawesome-webfont.woff'
//           }
...
//<link rel="stylesheet" type="text/css" href="/js/leaflet-fusesearch-master/src/leaflet.fusesearch.css" />
        ...
        , 'topojson.v1':                { 'require' : [], 'src': '/js/d3js.org/topojson.v1.min.js' }  // topojson in D3js
        , 'heatmap-dev':     				{ 'require' : []
											, 'waitFor' : ['Leaflet']
											, 'src': '/js/heatmap.js-develop/build/heatmap.min.js' }
        , 'heatmapLeaflet-dev':     		{ 'require' : []
											, 'waitFor' : ['Leaflet']
											, 'src': '/js/heatmap.js-develop/plugins/leaflet-heatmap.js' }
        , 'heatmap':     				{ 'require' : []
											, 'waitFor' : ['Leaflet']
											, 'src': '/js/heatmap.js-master/src/heatmap.js' }
        , 'heatmapLeaflet':     		{ 'require' : []
											, 'waitFor' : ['Leaflet']
											, 'src': '/js/heatmap.js-master/src/heatmap-leaflet.js' }
        , 'QuadTree':     				{ 'require' : []
											, 'waitFor' : ['Leaflet']
											, 'src': '/js/heatmap.js-master/src/QuadTree.js' }
        , 'Leaflet.heat':     				{ 'require' : []
											, 'waitFor' : ['Leaflet']
											, 'src': '/js/Leaflet.heat-gh-pages/dist/leaflet-heat.js' }
//        , 'Leaflet.heat':     				{ 'require' : []
//											, 'waitFor' : ['Leaflet']
//											, 'src': '/js/Leaflet.heat-gh-pages/src/HeatLayer.js' }
//        , 'simpleheat':     				{ 'require' : []  //for Leaflet.heat
//											, 'waitFor' : ['Leaflet']
//											, 'src': '/js/Leaflet.heat-gh-pages/src/simpleheat.js' }
        , 'YUI':                    	{ 'require' : []
											, 'depend' : ['YUI']
 											, 'src': '/js/yui3/yui/build/yui/yui.js' }
		, 'three':                    		{ 'require' : []
											, 'depend' : []
 											, 'src': '/js/mrdoob-three.js-ca14c79/build/three.min.js' }
		, 'tween':                    		{ 'require' : []
											, 'waitFor' : ['three']
											, 'depend' : []
 											, 'src': '/js/mrdoob-three.js-ca14c79/examples/js/libs/tween.min.js' }
		, 'CSS3DRenderer':        		{ 'require' : []
											, 'waitFor' : ['three']
											, 'depend' : []
 											, 'src': '/js/mrdoob-three.js-ca14c79/examples/js/renderers/CSS3DRenderer.js' }
		, 'TrackballControls':        		{ 'require' : []
											, 'waitFor' : ['three']
											, 'depend' : []
 											, 'src': '/js/mrdoob-three.js-ca14c79/examples/js/controls/TrackballControls.js' }
		, 'd3':                    		{ 'require' : []
											, 'depend' : ['d3']
 											, 'src': '/js/d3/d3.min.js' }
        , 'angular':                    	{ 'require' : []
											, 'depend' : ['angular']
 											, 'src': '/js/angular-1.2.16/angular.js' }
        , 'angular-route':              { 'require' : []
											, 'waitFor' : ['angular']
 											, 'src': '/js/angular-1.2.16/angular-route.js' }
        , 'jQuery':                    	{ 'require' : [], 'src': 'https://ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js' }  // alleen voor 3x $ in apri-leaflet ??
        , 'jquery-ui':              	{ 'require' : []
											, 'waitFor' : ['jQuery']
 											, 'src': '/js/jquery-ui-1.11.1.custom/jquery-ui.js' }
        , 'jquery.mousewheel':              { 'require' : []
											, 'waitFor' : ['jQuery']
 											, 'src': '/js/jquery-mousewheel-master/jquery.mousewheel.min.js' }
    };
