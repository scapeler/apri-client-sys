...
//	var apriUrlSkin		= apriUrlArray[5];
	...
	if (apriStartScreen.className == "init") {
    ...
    var apriApps = {
        'start-apri-main': {
           ...
           //     , {'id':'jQuery'}
            ...
            , 'src': '/apri-client-sys/lib/start-apri-main.js'
            , 'sleep' : 1
          }
...
//				, {'id':'APRI-webgl-base.css'}
	...
	//			, {'id':'jquery.mCustomScrollbar.css'}
			...
			, 'classGroup': 'ApriApps'	
			, 'src': '/apri-client-aireas/lib/aireas/aireas.js'
            , 'sleep' : 1
			}
		,  'apri-stats': {
              'waitFor' : [
		...
		//		, {'id':'fontawesome-webfont.woff'}				
			...
			, 'src': '/apri-client-sys/lib/apri-stats/apri-stats.js'
            , 'sleep' : 1
			}
...
//                , {'id':'heatmapLeaflet-dev'}
            ...
            , 'src': '/apri-client-sys/lib/start-apri-leaflet.js'
            , 'sleep' : 1
          }
        ,  'start-apri-leaflet-YUI-config': {
              'src': '/apri-client-sys/lib/start-apri-leaflet-YUI-config.js'
           }
        ,  'APRI-app-base': {
                'type': 'js'
              , 'src': '/apri-client-sys/lib/APRI/APRI-app-base.js'
           }
        ,  'APRI-panel': {
                'type': 'js'
				, 'require' : [
              ...
              , 'src': '/apri-client-sys/lib/APRI/APRI-panel.js'
           }
		, 'ApriD3Base':	{
			  'type': 'js'
			, 'require' : []
			, 'src': '/apri-client-sys/lib/APRI/APRI-d3-base.js' }
		, 'ApriAjaxBase':	{
			  'type': 'js'
			, 'require' : []
			, 'src': '/apri-client-sys/lib/APRI/APRI-ajax-base.js' }
		, 'sessionstorage':	{
			  'type': 'js'
			, 'require' : []
			, 'src': '/apri-client-sys/ext/sessionstorage.min.js' }
		, 'ApriLeafLetBase':	{
			  'type': 'js'
			, 'require' : []
			, 'src': '/apri-client-sys/lib/APRI/APRI-leaflet-base.js' }
		, 'ApriCookieBase':	{
			  'type': 'js'
			, 'require' : []
			, 'src': '/apri-client-sys/lib/APRI/APRI-cookie-base.js' }
		, 'ApriLeafLetCtrlBase':	{
			  'type': 'js'
			, 'require' : []
			, 'src': '/apri-client-sys/lib/APRI/APRI-leafletctrl-base.js' }
		, 'ApriLeafLetLayerBase':	{
			  'type': 'js'
			, 'require' : []
			, 'src': '/apri-client-sys/lib/APRI/APRI-leafletlayer-base.js' }
		, 'ApriD3Logo':	{
			  'type': 'js'
			, 'require' : ['ApriD3Base']
			, 'src': '/apri-client-sys/lib/APRI/APRI-d3-logo.js' }
		, 'ApriD3Graphic':	{
			  'type': 'js'
            , 'waitFor' : [
			    'ApriD3Base']
			, 'require' : ['ApriD3Base']
			, 'src': '/apri-client-sys/lib/APRI/APRI-d3-graphic.js' } 
		, 'ApriD3GraphicDouble':	{
			  'type': 'js'
            , 'waitFor' : [
			    'ApriD3Base']
			, 'require' : ['ApriD3Base']
			, 'src': '/apri-client-sys/lib/APRI/APRI-d3-graphic-double.js' } 
		, 'ApriD3GraphicTrend':	{
			  'type': 'js'
            , 'waitFor' : [
			    'ApriD3Base']
			, 'require' : ['ApriD3Base']
			, 'src': '/apri-client-sys/lib/APRI/APRI-d3-graphic-trend.js' } 
		, 'ApriD3GraphicGroupedHorBar':	{
			  'type': 'js'
            , 'waitFor' : [
			    'ApriD3Base']
			, 'require' : ['ApriD3Base']
			, 'src': '/apri-client-sys/lib/APRI/APRI-d3-graphic-groupedhorbar.js' } 
		, 'ApriD3Gauge':	{
			  'type': 'js'
            , 'waitFor' : [
			    'ApriD3Base']
			, 'require' : ['ApriD3Base']
			, 'src': '/apri-client-sys/lib/APRI/APRI-d3-gauge.js' } 			
		, 'ApriD3Menu':	{
			  'type': 'js'
            , 'waitFor' : [
			    'ApriD3Base']
			, 'require' : ['ApriD3Base']
			, 'src': '/apri-client-sys/lib/APRI/APRI-d3-menu.js' }
		, 'ApriVideoChat':	{
			  'type': 'js'
            , 'waitFor' : [
			    ]
			, 'require' : []
			, 'src': '/apri-client-sys/lib/APRI/APRI-videochat.js' } 	
		, 'ApriTreeBase':	{
			  'type': 'js'
            , 'waitFor' : []
			, 'require' : []
			, 'src': '/apri-client-sys/lib/APRI/APRI-tree-base.js' } 			
		, 'ApriD3Legend':	{
			  'type': 'js'
            , 'waitFor' : [
			    'ApriD3Base']
			, 'require' : ['ApriD3Base']
			, 'src': '/apri-client-sys/lib/APRI/APRI-d3-legend.js' } 			
		, 'ApriD3Spider':	{
			  'type': 'js'
            , 'waitFor' : [
			    'ApriD3Base']
			, 'require' : ['ApriD3Base']
			, 'src': '/apri-client-sys/lib/APRI/APRI-d3-spider.js' }
		, 'ApriThreeBase':	{
			  'type': 'js'
            , 'waitFor' : [
			    'three']
			, 'require' : ['three']
			, 'src': '/apri-client-sys/lib/APRI/APRI-three-base.js' }
		, 'apri-webgl-utils':	{
			  'type': 'js'
            , 'waitFor' : ['webgl-sylvester']
			, 'require' : ['webgl-sylvester']
			, 'src': '/apri-client-sys/lib/APRI/apri-webgl-utils.js' }
		, 'webgl-sylvester':	{
			  'type': 'js'
            , 'waitFor' : []
			, 'require' : []
			, 'src': '/apri-client-sys/lib/APRI/webgl-sylvester.js' }
		, 'ApriWebGlBase':	{
			  'type': 'js'
            , 'waitFor' : ['webgl-sylvester','apri-webgl-utils']
			, 'require' : ['apri-webgl-utils']
			, 'src': '/apri-client-sys/lib/APRI/APRI-webgl-base.js' }
		, 'ApriD3ForcedLayout':	{
			  'type': 'js'
            , 'waitFor' : [
			    'ApriD3Base']
			, 'require' : ['ApriD3Base']
			, 'src': '/apri-client-sys/lib/APRI/APRI-d3-forcedlayout.js' } 
        ,  'APRI-init.css': {
                'type': 'css'
              , 'href': '/apri-client-sys/lib/APRI/APRI-init.css'
           }
        ,  'start-apri-leaflet.css': {
                'type': 'css'
              , 'href': '/apri-client-sys/lib/start-apri-leaflet.css'
           }
//        ,  'start-apri-stats.css': {
//                'type': 'css'
//              , 'href': '/apri-client-sys/lib/start-apri-stats.css'
//           }
        ,  'apri-leaflet-base.css': {
                'type': 'css'
              , 'href': '/apri-client-sys/lib/apri-leaflet/apri-leaflet-base.css'
           }
        ,  'APRI-leaflet-base.css': {
                'type': 'css'
              , 'href': '/apri-client-sys/lib/APRI/APRI-leaflet-base.css'
           }
        ,  'APRI-leafletctrl-base.css': {
                'type': 'css'
              , 'href': '/apri-client-sys/lib/APRI/APRI-leafletctrl-base.css'
           }
        , 'apri-accounts':          {
				'type': 'js'
				, 'waitFor' : ['YUI']
		...
		/*			 {'id':'gallery-popup-calendar'}
                	...
                	, {'id':'gallery-accordion'}
		*/			]
              	, 'src': '/apri-client-sys/lib/apri-accounts/apri-accounts.js'
			}
        , 'apri-cal':               {
				'type': 'js'
				, 'waitFor' : ['YUI']
				, 'require' : [
              	...
              	, 'src': '/apri-client-sys/lib/apri-cal/apri-cal.js'
			}
        , 'apri-cal-todo':          {}
        , 'apri-entity':            {
				'type': 'js'
				, 'waitFor' : ['YUI']
              , 'src': '/apri-client-sys/lib/apri-entity/apri-entity.js'
			}
        , 'apri-entry':             {
                'type': 'js'
				, 'waitFor' : ['YUI']
              ...
              , 'src': '/apri-client-sys/lib/apri-entry/apri-entry.js'
			}
        , 'aprientry-product':             {
                'type': 'js'
				, 'waitFor' : ['YUI']
           ...
           //     	 {'id':'aprimodel-aprientry'}
			...
			//		, {'id':'aprientry-project'}
              ...
              , 'src': '/apri-client-sys/lib/aprientry-product/aprientry-product.js'
			}
        , 'aprientry-project':             {
                'type': 'js'
				, 'waitFor' : ['YUI']
           ...
           //     	 {'id':'aprimodel-aprientry'}
			...
			//		, {'id':'aprientry-project'}
              ...
              , 'src': '/apri-client-sys/lib/aprientry-project/aprientry-project.js'
			}
        , 'apri-events':            {
                'type': 'js'
				, 'waitFor' : ['YUI']
              , 'src': '/apri-client-sys/lib/apri-events/apri-events.js'
			}
        , 'apri-entrydetail':       {
                'type': 'js'
				, 'waitFor' : ['YUI']
...
//                	, {'id':'gallery-accordion'}
              ...
              , 'src': '/apri-client-sys/lib/apri-entrydetail/apri-entrydetail.js'
			}
        , 'apri-grid':              {}
        , 'apri-growl':             {}
        , 'apri-journalentry':      {}
        ...
        //        	, {'id':'gallery-accordion'}
              	...
              	, 'src': '/apri-client-sys/lib/apri-d3swimlane/apri-d3swimlane.js'
			}
        , 'apri-ldgr-entry':        {}
        , 'apri-login':             {
				'type': 'js'
              ...
              , 'src': '/apri-client-sys/lib/apri-login/apri-login.js'
			}
        , 'apri-main':              {
				'type': 'js'
				, 'waitFor' : ['YUI']
				, 'require' : [
              	...
              	, 'src': '/apri-client-sys/lib/apri-main/apri-main.js'
			}
        , 'apri-main-zorg':         {}
        , 'apri-rss':               {
				'type': 'js'
				...
				, 'require' : [
              	...
              	, 'src': '/apri-client-sys/lib/apri-rss/apri-rss.js'
			}
        , 'apri-tabview':           {
				'type': 'js'
              	, 'src': '/apri-client-sys/lib/apri-tabview/apri-tabview.js'
			}
        , 'apri-soundmanager-player':           {
				'type': 'js'
              	, 'src': '/apri-client-sys/lib/apri-soundmanager-player/apri-soundmanager-player.js'
			}
        , 'apri-accordion':         {
				'type': 'js'
				, 'require' : [
              	...
              	, 'src': '/apri-client-sys/lib/apri-accordion/apri-accordion.js'
			}
        , 'apri-explorer':          {
				'type': 'js'
				...
				//	,{'id': 'aprimodel-aprientrylist'}
              	...
              	, 'src': '/apri-client-sys/lib/apri-explorer/apri-explorer.js'
			}
		, 'apri-sm-treeview':          {
				'type': 'js'
				, 'require' : [
				...
				//	,{'id': 'aprimodel-aprientrylist'}
              	...
              	, 'src': '/apri-client-sys/lib/apri-sm-treeview/apri-sm-treeview.js'
			}
		, 'apri-sm-treeview-templates':          {
				'type': 'js'
				, 'require' : [
					]
              	, 'src': '/apri-client-sys/lib/apri-sm-treeview-templates/apri-sm-treeview-templates.js'
			}
		, 'apri-tree-informationable':          {
				'type': 'js'
				, 'require' : [
					]
              	, 'src': '/apri-client-sys/lib/apri-tree-informationable/apri-tree-informationable.js'
			}
		, 'apri-tree-audioplayable':          {
				'type': 'js'
				, 'require' : [
					]
              	, 'src': '/apri-client-sys/lib/apri-tree-audioplayable/apri-tree-audioplayable.js'
			}
		, 'apri-tree-refreshable':          {
				'type': 'js'
				, 'require' : [
					]
              	, 'src': '/apri-client-sys/lib/apri-tree-refreshable/apri-tree-refreshable.js'
			}
		, 'apri-tree-thumbnailable':          {
				'type': 'js'
				, 'require' : [
					]
              	, 'src': '/apri-client-sys/lib/apri-tree-thumbnailable/apri-tree-thumbnailable.js'
			}
		, 'apri-tree-workflowable':          {
				'type': 'js'
				, 'require' : [
					]
              	, 'src': '/apri-client-sys/lib/apri-tree-workflowable/apri-tree-workflowable.js'
			}
        , 'apri-uploader':             {
				'type': 'js'
				, 'require' : [
				...
				//{'id': 'aprimodel-forum'}
              	...
              	, 'src': '/apri-client-sys/lib/apri-uploader/apri-uploader.js'
			} 
        , 'apri-uploader-main':         {
				'type': 'js'
				, 'require' : [
				...
				//{'id': 'aprimodel-forum'}
              	...
              	, 'src': '/apri-client-sys/lib/apri-uploader-main/apri-uploader-main.js'
			} 
        , 'apri-uploader-html5':         {
				'type': 'js'
				, 'require' : [
					]
              	, 'src': '/apri-client-sys/lib/apri-uploader-html5/apri-uploader-html5.js'
			} 
        , 'apri-uploader-queue':         {
				'type': 'js'
				, 'require' : [
					]
              	, 'src': '/apri-client-sys/lib/apri-uploader-queue/apri-uploader-queue.js'
			} 
		, 'apri-wfltask':           {
				'type': 'js'
              	, 'src': '/apri-client-sys/lib/apri-wfltask/apri-wfltask.js'
			}
        , 'apri-forum':             {
				'type': 'js'
				, 'require' : [//{'id': 'aprimodel-forum'}
              	...
              	, 'src': '/apri-client-sys/lib/apri-forum/apri-forum.js'
			}
        , 'apri-search':            {
				'type': 'js'
				, 'waitFor' : ['YUI']
				...
				, 'src': '/apri-client-sys/lib/apri-search/apri-search.js'
			}
        , 'apri-videochat':         {
				'type': 'js'
				, 'waitFor' : ['YUI']
				...
				, 'src': '/apri-client-sys/lib/apri-videochat/apri-videochat.js'
			}
        , 'apri-videoplayer':       {
				'type': 'js'
				, 'waitFor' : ['YUI']
				...
				, 'src': '/apri-client-sys/lib/apri-videoplayer/apri-videoplayer.js'
			}
        , 'apri-d3topoview':        {}
        , 'apri-leaflet':           {
                'type': 'js'
				, 'waitFor' : ['YUI']
              , 'src': '/apri-client-sys/lib/apri-leaflet/apri-leaflet.js'
...
//			}
        , 'apri-ocd':             {
				...
				, 'src': '/apri-client-sys/lib/apri-ocd/apri-ocd.js'
			}
        , 'apri-rijks':             {
				'type': 'js'
				, 'waitFor' : ['YUI']
				...
				, 'src': '/apri-client-sys/lib/apri-rijks/apri-rijks.js'
			}
        , 'apri-rijksdetail':       {angular:true
				, 'src': '/apri-client-sys/lib/apri-rijksdetail/apri-rijksdetail.js'
			}
        , 'apri-treinplanner':      {
				'type': 'js'
				, 'waitFor' : ['YUI']
				...
				, 'src': '/apri-client-sys/lib/apri-treinplanner/apri-treinplanner.js'
			}			
        , 'apri-tripplanner':              {
				'type': 'js'
				, 'waitFor' : ['YUI']
				, 'require' : [
              	...
              	, 'src': '/apri-client-sys/lib/apri-tripplanner/apri-tripplanner.js'
			}
        ...
        , 'handlebars':                	{ 'require' : []
											, 'depend' : []
											, 'src': '/apri-client-sys/ext/handlebars-v3.0.3.js' }
									//		, 'src': '/apri-client-sys/ext/handlebars-v2.0.0.js' }
        , 'handlebars-runtime':                	{ 'require' : []
											, 'depend' : []
//											, 'src': '/apri-client-sys/ext/handlebars.runtime-v2.0.0.js' }
											, 'src': '/apri-client-sys/ext/handlebars.runtime-v3.0.3.js' }
//        , 'CookieWarning':                	{ 'require' : []
//											, 'depend' : []
//											, 'src': '/apri-client-sys/ext/CookieWarning-master/js/cookiewarning3.js' } 
        , 'Leaflet':                	{ 'require' : []
											, 'depend' : ['L']
											, 'src': '/apri-client-sys/ext/leaflet-0.7.3/leaflet.js' } 
        , 'proj4-compressed':           { 'require' : ['Leaflet']
											, 'depend' : ['proj4']
											, 'src': '/apri-client-sys/ext/Proj4Leaflet-master/lib/proj4-compressed.js' }
        , 'proj4leaflet':               { 'require' : ['proj4-compressed']
										 , 'waitFor' : ['Leaflet','proj4-compressed']
										 , 'depend' : []
										 , 'src': '/apri-client-sys/ext/Proj4Leaflet-master/src/proj4leaflet.js' }
        , 'leaflet-sidebar-v2':               { 'require' : []
										 , 'waitFor' : ['Leaflet']
										 , 'depend' : []
										 , 'src': '/apri-client-sys/ext/sidebar-v2-gh-pages/js/leaflet-sidebar.min.js' }
        , 'apri-leafletctrl-timeslider':      { 'require' : ['d3']
                                            , 'waitFor' : ['d3']
                                            , 'src': '/apri-client-sys/lib/APRI/APRI-leafletctrl-timeslider.js' }
        , 'apri-leafletctrl-timeslider.css':      { 'require' : []
 			               ,'type': 'css'
                                            , 'waitFor' : []
                                            , 'href': '/apri-client-sys/lib/APRI/APRI-leafletctrl-timeslider.css' }
        , 'apri-leafletctrl-popupinfo':      { 'require' : ['d3']
                                            , 'waitFor' : ['d3']
                                            , 'src': '/apri-client-sys/lib/APRI/APRI-leafletctrl-popupinfo.js' }
        , 'apri-leafletctrl-popupinfo.css':      { 'require' : []
 			               ,'type': 'css'
                                            , 'waitFor' : []
                                            , 'href': '/apri-client-sys/lib/APRI/APRI-leafletctrl-popupinfo.css' }
        , 'L.Control.ApriSideBar':      { 'require' : []
                                            , 'waitFor' : ['Leaflet']
                                            , 'src': '/apri-client-sys/lib/apri-leaflet-aprisidebar/src/L.Control.ApriSideBar.js' }
        , 'L.Control.AccountInfo':      { 'require' : []
                                            , 'waitFor' : ['Leaflet']
                                            , 'src': '/apri-client-sys/lib/apri-leaflet-accountinfo/src/L.Control.AccountInfo.js' }
        , 'L.Control.ExplorerInfo':     { 'require' : []
                                            , 'waitFor' : ['Leaflet']
                                            , 'src': '/apri-client-sys/lib/apri-leaflet-explorerinfo/src/L.Control.ExplorerInfo.js' }
        , 'L.Control.RijksInfo':        { 'require' : []
                                            , 'waitFor' : ['Leaflet']
                                            , 'src': '/apri-client-sys/lib/apri-leaflet-rijksinfo/src/L.Control.RijksInfo.js' }
        , 'L.Control.NsTreinInfo':      { 'require' : []
                                            , 'waitFor' : ['Leaflet']
                                            , 'src': '/apri-client-sys/lib/apri-leaflet-nstreininfo/src/L.Control.NsTreinInfo.js' }
        , 'L.Control.TripPlannerInfo':      { 'require' : []
                                            , 'waitFor' : ['Leaflet']
                                            , 'src': '/apri-client-sys/lib/apri-leaflet-tripplannerinfo/src/L.Control.TripPlannerInfo.js' }
        , 'L.Control.Sidebar':          { 'require' : []
                                            , 'waitFor' : ['Leaflet']
                                            , 'src': '/apri-client-sys/ext/leaflet-sidebar-master/src/L.Control.Sidebar.js' }
        , 'L.Control.ThemeInfo':          	{ 'require' : []
                                            , 'waitFor' : ['Leaflet']
                                            , 'src': '/apri-client-sys/lib/apri-leaflet-themeinfo/src/L.Control.ThemeInfo.js' }
        , 'L.Control.TimeLineInfo':     { 'require' : []
                                            , 'waitFor' : ['Leaflet']
                                            , 'src': '/apri-client-sys/lib/apri-leaflet-timelineinfo/src/L.Control.TimeLineInfo.js' }
        , 'L.Control.Layers.Minimap':   { 'require' : []
                                            , 'waitFor' : ['Leaflet']
											, 'src': '/apri-client-sys/ext/Leaflet.layerscontrol-minimap-gh-pages/L.Control.Layers.Minimap.js'
										}
        , 'L.Map.Sync':            		{ 'require' : []
                                            , 'waitFor' : ['Leaflet']
											, 'src': '/apri-client-sys/ext/Leaflet.layerscontrol-minimap-gh-pages/lib/L.Map.Sync.js'
										}
        , 'Control.MiniMap':            { 'require' : []
                                            , 'waitFor' : ['Leaflet']
											, 'depend' : ['L.Control.MiniMap']
											, 'src': '/apri-client-sys/ext/Leaflet-MiniMap-master/src/Control.MiniMap.js'
										}
        , 'L.Control.Locate':           { 'require' : []
                                            , 'waitFor' : ['Leaflet']
                                            , 'src': '/apri-client-sys/ext/leaflet-locatecontrol-gh-pages/src/L.Control.Locate.js' }
        , 'Control.Loading':            { 'require' : []
                                            , 'waitFor' : ['Leaflet']
                                            , 'src': '/apri-client-sys/ext/Leaflet.loading-master/src/Control.Loading.js' }
        , 'Control.FullScreen':         { 'require' : []
                                            , 'waitFor' : ['Leaflet']
                                            , 'src': '/apri-client-sys/ext/brunob-leaflet.fullscreen-342abea/Control.FullScreen.js' }
        , 'leaflet.draw':               { 'require' : []
                                            , 'waitFor' : ['Leaflet']
                                            , 'src': '/apri-client-sys/ext/Leaflet.draw-master/dist/leaflet.draw-src.js' }
//        , 'leaflet.draw.Edit.Rectangle': { 'require' : []
//                                            , 'waitFor' : ['Leaflet']
//                                            , 'src': '/apri-client-sys/ext/Leaflet.draw-master/src/edit/handler/Edit.Rectangle.js' }
        , 'leaflet.measurecontrol':     { 'require' : []
                                            , 'waitFor' : ['Leaflet','leaflet.draw']
											, 'depend' : []
											, 'src': '/apri-client-sys/ext/Leaflet.MeasureControl-gh-pages/leaflet.measurecontrol.js'
										}
        , 'apri-leaflet-styleeditor':   { 'require' : [{'id': 'apri-entrydetail'}]
                                            , 'waitFor' : ['Leaflet']
                                            , 'src': '/apri-client-sys/lib/apri-leaflet-styleeditor/src/javascript/apri-leaflet-styleeditor.js' }
        , 'apri-leaflet-formeditor':    { 'require' : []
                                            , 'waitFor' : ['Leaflet']
                                            , 'src': '/apri-client-sys/lib/apri-leaflet-styleeditor/src/javascript/apri-leaflet-styleforms.js' }
        , 'leaflet.ajax':               { 'require' : []
                                            , 'waitFor' : ['Leaflet']
                                            , 'src': '/apri-client-sys/ext/leaflet-ajax-master/dist/leaflet.ajax.min.js' }
        , 'leaflet.contextmenu':      	{ 'require' : []
                                            , 'waitFor' : ['Leaflet']
                                            , 'src': '/apri-client-sys/ext/Leaflet.contextmenu-master/dist/leaflet.contextmenu.js' }
        , 'leaflet.markercluster':      { 'require' : []
                                            , 'waitFor' : ['Leaflet']
                                            , 'src': '/apri-client-sys/ext/Leaflet.markercluster-master/dist/leaflet.markercluster.js' }
        , 'leaflet-oms':      			{ 'require' : []
                                            , 'waitFor' : ['Leaflet']
                                            , 'src': '/apri-client-sys/ext/Leaflet-overlappingmarkerspiderfier/oms.min.js' }
        , 'leaflet.plotter':      		{ 'require' : []
                                            , 'waitFor' : ['Leaflet']
                                            , 'src': '/apri-client-sys/ext/leaflet-plotter-master/dist/leaflet.plotter.min.js' }
        , 'moment':                     { 'require' : [], 'src': '/apri-client-sys/ext/moment.min.js' }
        , 'video-js':                     { 'require' : [], 'src': '/apri-client-sys/ext/video-js/video.js' }
   //     , 'timeline':                   { 'require' : [], 'src': '/apri-client-sys/lib/TimelineJS-master/build/js/timeline-min.js' } //automaticly loaded by storyjs-embed
        , 'timeline-storyjs-embed':     { 'require' : [], 'src': '/apri-client-sys/lib/TimelineJS-master/build/js/storyjs-embed.js' }


        , 'gallery-formmgr': {
                'type': 'js'
				, 'waitFor' : ['YUI']
              , 'src': '/apri-client-sys/ext/yui3/yui-gallery/gallery-formmgr/gallery-formmgr-min.js'
           }
        , 'gallery-popup-calendar': {
                'type': 'js'
				, 'waitFor' : ['YUI']
				, 'require' : [{'id': 'gallery-popup-calendar.css'}]
              , 'src': '/apri-client-sys/ext/gallery-popup-calendar/gallery-popup-calendar.js'
           }
        , 'gallery-accordion': {
                'type': 'js'
				, 'waitFor' : ['YUI']
				, 'require' : [{'id': 'gallery-accordion.css'}]
              , 'src': '/apri-client-sys/ext/gallery-accordion/gallery-accordion.js'
           }
        ...
        , 'timeline.css': {
                'type': 'css'
              , 'href': '/apri-client-sys/lib/TimelineJS-master/build/css/timeline.css'
           }
//        , 'jquery.mCustomScrollbar.css': {
//                'type': 'css'
//              , 'href': '/apri-client-sys/ext/malihu-custom-scrollbar-plugin-master/jquery.mCustomScrollbar.css'
//           }

        , 'gallery-popup-calendar.css': {
                'type': 'css'
              , 'href': '/apri-client-sys/ext/gallery-popup-calendar/assets/skins/sam/gallery-popup-calendar-skin.css'
           }
        , 'gallery-accordion.css': {
                'type': 'css'
              , 'href': '/apri-client-sys/ext/gallery-accordion/assets/skins/sam/gallery-accordion.css'
           }

        , 'apri-open-sans-fontfacekit.css': {
                'type': 'css'
              , 'href': '/apri-client-sys/lib/apri-open-sans-fontfacekit/stylesheet.css'
           }
        , 'cssbutton.css': {
                'type': 'css'
              , 'href': '/apri-client-sys/lib/cssbutton/cssbutton.css'
           }
        , 'cssgrids-min.css': {
                'type': 'css'
              , 'href': '/apri-client-sys/ext/yui3/yui/build/cssgrids/cssgrids-min.css'
           }
        , 'cssbase-min.css': {
                'type': 'css'
              , 'href': '/apri-client-sys/ext/yui3/yui/build/cssbase/cssbase-min.css'
           }
...
//<link ref="stylesheet" type="text/css" href="/js/yui3/yui/build/cssbase/cssbase-min.css"/>
        ...
        , 'leaflet.css': {
                'type': 'css'
              , 'href': '/apri-client-sys/ext/leaflet-0.7.2/leaflet.css'
           }
        , 'leaflet-sidebar-v2.css': {
                'type': 'css'
              , 'href': '/apri-client-sys/ext/sidebar-v2-gh-pages/css/leaflet-sidebar.css'

           }
        , 'leaflet-sidebar-v2.scss': {
                'type': 'css'
              , 'href': '/apri-client-sys/ext/sidebar-v2-gh-pages/scss/leaflet-sidebar.scss'
           }
        , 'leaflet-sidebar-v2-base.scss': {
                'type': 'css'
              , 'href': '/apri-client-sys/ext/sidebar-v2-gh-pages/scss/_base.scss'
           }
		, 'apri-accordion.css': {
                'type': 'css'
              , 'href': '/apri-client-sys/lib/apri-accordion/assets/skins/sam/apri-accordion.css'
           }
        , 'apri-entrydetail.css': {
                'type': 'css'
              , 'href': '/apri-client-sys/lib/apri-entrydetail/apri-entrydetail.css'
           }
        , 'aprientry-product.css': {
                'type': 'css'
              , 'href': '/apri-client-sys/lib/aprientry-product/assets/skins/sam/aprientry-product.css'
           }
        , 'aprientry-project.css': {
                'type': 'css'
              , 'href': '/apri-client-sys/lib/aprientry-project/assets/skins/sam/aprientry-project.css'
           }
        , 'apri-forum.css': {
                'type': 'css'
              , 'href': '/apri-client-sys/lib/apri-forum/assets/skins/sam/apri-forum.css'
           }
        , 'apri-search.css': {
                'type': 'css'
              , 'href': '/apri-client-sys/lib/apri-search/assets/skins/sam/apri-search.css'
           }
        , 'apri-leaflet.css': {
                'type': 'css'
              , 'href': '/apri-client-sys/lib/apri-leaflet/assets/skins/sam/apri-leaflet.css'
           }
        , 'apri-air.css': {
                'type': 'css'
              , 'href': '/apri-client-aireas/lib/aireas/aireas.css'
           }		   
        , 'apri-stats.css': {
                'type': 'css'
              , 'href': '/apri-client-sys/lib/apri-stats/apri-stats.css'
           }		   
        , 'APRI-d3-graphic.css': {
                'type': 'css'
              , 'href': '/apri-client-sys/lib/APRI/APRI-d3-graphic.css'
           }
        , 'APRI-d3-graphic-double.css': {
                'type': 'css'
              , 'href': '/apri-client-sys/lib/APRI/APRI-d3-graphic-double.css'
           }
        , 'APRI-d3-graphic-trend.css': {
                'type': 'css'
              , 'href': '/apri-client-sys/lib/APRI/APRI-d3-graphic-trend.css'
           }
        , 'APRI-d3-graphic-groupedhorbar.css': {
                'type': 'css'
              , 'href': '/apri-client-sys/lib/APRI/APRI-d3-graphic-groupedhorbar.css'
           }
        , 'APRI-d3-gauge.css': {
                'type': 'css'
              , 'href': '/apri-client-sys/lib/APRI/APRI-d3-gauge.css'
           }		   		   		   
        , 'APRI-d3-menu.css': {
                'type': 'css'
              , 'href': '/apri-client-sys/lib/APRI/APRI-d3-menu.css'
           }		   		   		   
        , 'APRI-d3-legend.css': {
                'type': 'css'
              , 'href': '/apri-client-sys/lib/APRI/APRI-d3-legend.css'
           }		   		   		   
        , 'APRI-d3-spider.css': {
                'type': 'css'
              , 'href': '/apri-client-sys/lib/APRI/APRI-d3-spider.css'
           }		   		   		   
        , 'APRI-three-base.css': {
                'type': 'css'
              , 'href': '/apri-client-sys/lib/APRI/APRI-three-base.css'
           }		   		   		   
        , 'APRI-webgl-base.css': {
                'type': 'css'
              , 'href': '/apri-client-sys/lib/APRI/APRI-webgl-base.css'
           }		   		   		   
        , 'apri-login.css': {
                'type': 'css'
              , 'href': '/apri-client-sys/lib/apri-login/assets/skins/sam/apri-login.css'
           }
        ...
        , 'apri-main.css': {
                'type': 'css'
              , 'href': '/apri-client-sys/lib/apri-main/assets/skins/sam/apri-main.css'
           }
        , 'apri-ocd.css': {
                'type': 'css'
              , 'href': '/apri-client-sys/lib/apri-ocd/assets/skins/sam/apri-ocd.css'
           }
        , 'apri-rijks.css': {
                'type': 'css'
              , 'href': '/apri-client-sys/lib/apri-rijks/assets/skins/sam/apri-rijks.css'
           }
        , 'apri-d3swimlane.css': {
                'type': 'css'
              , 'href': '/apri-client-sys/lib/apri-d3swimlane/assets/skins/sam/apri-d3swimlane.css'
           }
        , 'apri-treinplanner.css': {
                'type': 'css'
              , 'href': '/apri-client-sys/lib/apri-treinplanner/assets/skins/sam/apri-treinplanner.css'
           }
        , 'apri-tripplanner.css': {
                'type': 'css'
              , 'href': '/apri-client-sys/lib/apri-tripplanner/assets/skins/sam/apri-tripplanner.css'
           }
        , 'apri-sm-treeview.css': {
                'type': 'css'
              , 'href': '/apri-client-sys/lib/apri-sm-treeview/assets/skins/sam/apri-sm-treeview.css'
           }
...
//<link rel="stylesheet" href="/js/leaflet-0.7.2/leaflet.css" />
        ...
        , 'L.Control.ApriSideBar.css': {
                'type': 'css'
              , 'href': '/apri-client-sys/lib/apri-leaflet-aprisidebar/src/L.Control.ApriSideBar.css'
           }
        , 'L.Control.AccountInfo.css': {
                'type': 'css'
              , 'href': '/apri-client-sys/lib/apri-leaflet-accountinfo/src/L.Control.AccountInfo.css'
           }
        , 'L.Control.ExplorerInfo.css': {
                'type': 'css'
              , 'href': '/apri-client-sys/lib/apri-leaflet-explorerinfo/src/L.Control.ExplorerInfo.css'
           }
        , 'L.Control.RijksInfo.css': {
                'type': 'css'
              , 'href': '/apri-client-sys/lib/apri-leaflet-rijksinfo/src/L.Control.RijksInfo.css'
           }
        , 'L.Control.NsTreinInfo.css': {
                'type': 'css'
              , 'href': '/apri-client-sys/lib/apri-leaflet-nstreininfo/src/L.Control.NsTreinInfo.css'
           }
        , 'L.Control.TripPlannerInfo.css': {
                'type': 'css'
              , 'href': '/apri-client-sys/lib/apri-leaflet-tripplannerinfo/src/L.Control.TripPlannerInfo.css'
           }
        , 'L.Control.TimeLineInfo.css': {
                'type': 'css'
              , 'href': '/apri-client-sys/lib/apri-leaflet-timelineinfo/src/L.Control.TimeLineInfo.css'
           }
        , 'L.Control.ThemeInfo.css': {
                'type': 'css'
              , 'href': '/apri-client-sys/lib/apri-leaflet-themeinfo/src/L.Control.ThemeInfo.css'
           }
        , 'apri-leaflet-styleeditor.css': {
                'type': 'css'
              , 'href': '/apri-client-sys/lib/apri-leaflet-styleeditor/src/css/apri-leaflet-styleeditor.css'
           }
        , 'leaflet.contextmenu.css': {
                  'type': 'css'
				, 'href': '/apri-client-sys/ext/Leaflet.contextmenu-master/dist/leaflet.contextmenu.css' 
			}
        , 'MarkerCluster.Default.css': {
                'type': 'css'
              , 'href': '/apri-client-sys/ext/Leaflet.markercluster-master/dist/MarkerCluster.Default.css'
           }
        , 'MarkerCluster.css': {
                'type': 'css'
              , 'href': '/apri-client-sys/ext/Leaflet.markercluster-master/dist/MarkerCluster.css'
           }
        , 'leaflet.draw.css': {
                'type': 'css'
              , 'href': '/apri-client-sys/ext/Leaflet.draw-master/dist/leaflet.draw.css'
           }
        , 'Control.MiniMap.css': {
                'type': 'css'
              , 'href': '/apri-client-sys/ext/Leaflet-MiniMap-master/src/Control.MiniMap.css'
           }
        , 'L.Control.Locate.css': {
                'type': 'css'
              , 'href': '/apri-client-sys/ext/leaflet-locatecontrol-gh-pages/src/L.Control.Locate.css'
           }
        , 'Control.FullScreen.css': {
                'type': 'css'
              , 'href': '/apri-client-sys/ext/brunob-leaflet.fullscreen-342abea/Control.FullScreen.css'
           }
        , 'Control.Loading.css': {
                'type': 'css'
              , 'href': '/apri-client-sys/ext/Leaflet.loading-master/src/Control.Loading.css'
           }
        , 'leaflet.measurecontrol.css': {
                'type': 'css'
              , 'href': '/apri-client-sys/ext/Leaflet.MeasureControl-gh-pages/leaflet.measurecontrol.css'
           }
        , 'control.layers.minimap.css': {
                'type': 'css'
              , 'href': '/apri-client-sys/ext/Leaflet.layerscontrol-minimap-gh-pages/control.layers.minimap.css'
           }
        , 'L.Control.Sidebar.css': {
                'type': 'css'
              , 'href': '/apri-client-sys/ext/leaflet-sidebar-master/src/L.Control.Sidebar.css'
           }
        , 'leaflet.fusesearch.css': {
                'type': 'css'
              , 'href': '/apri-client-sys/ext/leaflet-fusesearch-master/src/leaflet.fusesearch.css'
           }
        , 'font-awesome-4.2.0.css': {
                'type': 'css'
              //, 'href': '/apri-client-sys/ext/font-awesome-4.2.0/css/font-awesome.css'
			  , 'href': 'https://maxcdn.bootstrapcdn.com/font-awesome/4.2.0/css/font-awesome.min.css'
           }
        , 'leaflet.awesome-markers.css': {
                'type': 'css'
              //, 'href': '/apri-client-sys/ext/font-awesome-4.2.0/css/font-awesome.css'
			  , 'href': '/apri-client-sys/ext/Leaflet.awesome-markers-2.0-develop/dist/leaflet.awesome-markers.css'
           }
        , 'leaflet.awesome-markers': {
                'require' : []
              , 'waitFor' : ['Leaflet']
			  , 'src': '/apri-client-sys/ext/Leaflet.awesome-markers-2.0-develop/dist/leaflet.awesome-markers.min.js'
           }
//        , 'fontawesome-webfont.woff': {
//                'type': 'css'
//              , 'href': '/apri-client-sys/ext/font-awesome-4.2.0/fonts/fontawesome-webfont.woff'
//           }
...
//<link rel="stylesheet" type="text/css" href="/js/leaflet-fusesearch-master/src/leaflet.fusesearch.css" />
        ...
        , 'topojson.v1':                { 'require' : [], 'src': '/apri-client-sys/ext/d3js.org/topojson.v1.min.js' }  // topojson in D3js
        , 'heatmap-dev':     				{ 'require' : []
											, 'waitFor' : ['Leaflet']
											, 'src': '/apri-client-sys/ext/heatmap.js-develop/build/heatmap.min.js' }
        , 'heatmapLeaflet-dev':     		{ 'require' : []
											, 'waitFor' : ['Leaflet']
											, 'src': '/apri-client-sys/ext/heatmap.js-develop/plugins/leaflet-heatmap.js' }
        , 'heatmap':     				{ 'require' : []
											, 'waitFor' : ['Leaflet']
											, 'src': '/apri-client-sys/ext/heatmap.js-master/src/heatmap.js' }
        , 'heatmapLeaflet':     		{ 'require' : []
											, 'waitFor' : ['Leaflet']
											, 'src': '/apri-client-sys/ext/heatmap.js-master/src/heatmap-leaflet.js' }
        , 'QuadTree':     				{ 'require' : []
											, 'waitFor' : ['Leaflet']
											, 'src': '/apri-client-sys/ext/heatmap.js-master/src/QuadTree.js' }
        , 'Leaflet.heat':     				{ 'require' : []
											, 'waitFor' : ['Leaflet']
											, 'src': '/apri-client-sys/ext/Leaflet.heat-gh-pages/dist/leaflet-heat.js' }
//        , 'Leaflet.heat':     				{ 'require' : []
//											, 'waitFor' : ['Leaflet']
//											, 'src': '/apri-client-sys/ext/Leaflet.heat-gh-pages/src/HeatLayer.js' }
//        , 'simpleheat':     				{ 'require' : []  //for Leaflet.heat
//											, 'waitFor' : ['Leaflet']
//											, 'src': '/apri-client-sys/ext/Leaflet.heat-gh-pages/src/simpleheat.js' }
        , 'YUI':                    	{ 'require' : []
											, 'depend' : ['YUI']
 											, 'src': '/apri-client-sys/ext/yui3/yui/build/yui/yui.js' }
		, 'three':                    		{ 'require' : []
											, 'depend' : []
 											, 'src': '/apri-client-sys/ext/mrdoob-three.js-ca14c79/build/three.min.js' }
		, 'tween':                    		{ 'require' : []
											, 'waitFor' : ['three']
											, 'depend' : []
 											, 'src': '/apri-client-sys/ext/mrdoob-three.js-ca14c79/examples/js/libs/tween.min.js' }
		, 'CSS3DRenderer':        		{ 'require' : []
											, 'waitFor' : ['three']
											, 'depend' : []
 											, 'src': '/apri-client-sys/ext/mrdoob-three.js-ca14c79/examples/js/renderers/CSS3DRenderer.js' }
		, 'TrackballControls':        		{ 'require' : []
											, 'waitFor' : ['three']
											, 'depend' : []
 											, 'src': '/apri-client-sys/ext/mrdoob-three.js-ca14c79/examples/js/controls/TrackballControls.js' }
		, 'd3':                    		{ 'require' : []
											, 'depend' : ['d3']
 											, 'src': '/apri-client-sys/ext/d3/d3.min.js' }
        , 'angular':                    	{ 'require' : []
											, 'depend' : ['angular']
 											, 'src': '/apri-client-sys/ext/angular-1.2.16/angular.js' }
        , 'angular-route':              { 'require' : []
											, 'waitFor' : ['angular']
 											, 'src': '/apri-client-sys/ext/angular-1.2.16/angular-route.js' }
        , 'jQuery':                    	{ 'require' : [], 'src': 'https://ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js' }  // alleen voor 3x $ in apri-leaflet ??
        , 'jquery-ui':              	{ 'require' : []
											, 'waitFor' : ['jQuery']
 											, 'src': '/apri-client-sys/ext/jquery-ui-1.11.1.custom/jquery-ui.js' }
        , 'jquery.mousewheel':              { 'require' : []
											, 'waitFor' : ['jQuery']
 											, 'src': '/apri-client-sys/ext/jquery-mousewheel-master/jquery.mousewheel.min.js' }
    };
...
*/
    ...
    apri.loader = function(id, options, callbackInitiator ) {  // eg. id="start-apri-leaflet"; src="/js/tool/tool.js"
		...
		if (options && apriApps[id].className && apriApps[id].className) {
...
*/
    ...
    function scriptLoaded(scriptNode, callback ) {
		...
		if (waitForArrayDoneIndex == tmpRequireArray.length && callbackInitiator && typeof(callbackInitiator) === "function") {
			...
			var apriStartScreen = document.getElementById('apri-startup-screen');
			if (apriStartScreen.className != "hide") {
