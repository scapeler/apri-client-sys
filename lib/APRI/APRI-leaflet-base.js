...
var ApriLeafLetBase = ApriCore.ApriLeafLetBase = ApriCore.ApriLeafLetBase || Class.extend(function () {
	...
	var _viewCoordinates 	= [52.490, 4.97]; // default values
	var _viewZoomLevel 		= 12 // default values
	
	var defaultMapBaseLayerUrl = 'https://scapeler.com/extern/{s}.tile.openstreetmap.fr/hot/{z}/{x}/{y}.png';
	var defaultMapLayerAttribution = '&copy; <a href="https://scapeler.com/extern/openstreetmap.org">OpenStreetMap</a> contributors, <a href="https://scapeler.com/extern/creativecommons.org/licenses/by-sa/2.0/">CC-BY-SA</a>, Tiles courtesy of <a href="https://scapeler.com/extern/hot.openstreetmap.org/' ;
	...
	this.mapBody;
	this.mapFooter;
	var mapHeaderHeight=80;  // default value
	var mapFooterHeight=60;  // default value 
	...
	this.createMap = function(container, options ) {
		...
		if (options && options.viewCoordinates) _viewCoordinates 	= options.viewCoordinates;
		if (options && options.viewZoomLevel) 	_viewZoomLevel 		= options.viewZoomLevel;
		...
		var _resize = function () {
			...
			var _ll = container.getElementsByClassName('leaflet-container')[0];
			_ll.style.height 	= (offsetSize.height-mapHeaderHeight-mapFooterHeight)+'px'; //
		...
		map = L.map(this.mapBody, { maxZoom: 18
			...
			.setView(_viewCoordinates, _viewZoomLevel)
			;
		//map.setZoom(_viewZoomLevel);
		//map.maxZoom(6);
